...
final class CreateRefreshTokensTable extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('user_type', 'string', [
            ...
            'comment' => 'Logged in user hashed refresh token.',
            ...
            'comment' => 'Date and time refresh_token record expires.',
        ])->addColumn('created_at', 'datetime', [
            'default' => 'CURRENT_TIMESTAMP',
            'comment' => 'Date and time refresh_token record was created.',
        ])->addIndex(
            ['token_hash'],
            [
                'unique' => true,
                'name' => 'refresh_tokens_token_hash_unique_index',
            ]
        )->create();
    }
}
